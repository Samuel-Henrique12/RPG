...
// Criação do Mestre Raiden
class Raiden extends Mestre {
    public Raiden (String nomeMestre, int vidaMestre, int ataqueMestre, int defesaMestre) {
        super(nomeMestre, vidaMestre, ataqueMestre, defesaMestre);
        this.nomeMestre = "Raiden";
        this.vidaMestre = 100;
        this.ataqueMestre = 50;
        this.defesaMestre = 20;
    }
}
// Criação do Mestre Enma
class Enma extends Mestre {
    public Enma (String nomeMestre, int vidaMestre, int ataqueMestre, int defesaMestre) {
        super(nomeMestre, vidaMestre, ataqueMestre, defesaMestre);
        this.nomeMestre = "Enma";
        this.vidaMestre = 100;
        this.ataqueMestre = 50;
        this.defesaMestre = 20;
    }
}
// Criação do Mestre Kirishima
class Kirishima extends Mestre {
    public Kirishima (String nomeMestre, int vidaMestre, int ataqueMestre, int defesaMestre) {
        super(nomeMestre, vidaMestre, ataqueMestre, defesaMestre);
        this.nomeMestre = "Kirishima";
        this.vidaMestre = 100;
        this.ataqueMestre = 50;
        this.defesaMestre = 20;
    }
...
class Shogun extends Personagem {
    public Shogun (String nome) {
        super(nome);
        this.classe = "Shogun";
        this.vida = 100;
        this.ataque = 55;
...
Class Batalha {
    public void iniciarBatalha(Personagem jogador, Inimigo inimigo) {
